...
This document shows an example of how using GBIF species occurence cubes to assess the emerging status of some (alien) species in Europe. This workflow is strongly based on [**occurrence TrIAS indicators**](https://github.com/trias-project/indicators).
...
species <- tibble::tibble(
  specieskey = c(2891774, 5217334, 5361762, 5082110),
...
We triggered a GBIF occurrence cube via the [Occurrence SQL Download API](https://techdocs.gbif.org/en/data-use/api-sql-downloads) and on the hand of a [JSON query](data/input/query_for_GAM_graphs.json) The [resulting cube](https://doi.org/10.15468/dl.93evf5) (key: `0066568-241126133413365`) is open and can be downloaded in TSV format from GBIF.
